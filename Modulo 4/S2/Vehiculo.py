...
class Vehiculo:
    ...
    # constructor vacio o constructor sin parámetros, se pueden omitir los atributos    
    ...
    # accesadores y mutadores, se usan para modificar los atributos del objeto
    
    def get_marca(self):    # vehiculo.get_marca()
        return self.marca
    
    def set_marca(self, marca): #vehiculo.get_marca("Toyota")
        self.marca = marca
